...
import static tech.iooo.boot.netty.utils.HexUtils.byteToHexLE;
import static tech.iooo.boot.netty.utils.UnsafeUtils.unsafe;
...
public final class ObjectId implements Serializable {
  ...
  public String toHexString() {
    ...
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 8, byteToHexLE(union >>> 56));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 10, byteToHexLE(union >>> 48));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 12, byteToHexLE(union >>> 40));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 14, byteToHexLE(union >>> 32));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 16, byteToHexLE(union >>> 24));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 18, byteToHexLE(union >>> 16));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 20, byteToHexLE(union >>> 8));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 22, byteToHexLE(union));
  ...
  public String toHexString32() {
    ...
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 8 + 8, byteToHexLE(union >>> 56));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 10 + 8, byteToHexLE(union >>> 48));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 12 + 8, byteToHexLE(union >>> 40));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 14 + 8, byteToHexLE(union >>> 32));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 16 + 8, byteToHexLE(union >>> 24));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 18 + 8, byteToHexLE(union >>> 16));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 20 + 8, byteToHexLE(union >>> 8));
    unsafe().putShortVolatile(bytes, ARRAY_BYTE_BASE_OFFSET + 22 + 8, byteToHexLE(union));
