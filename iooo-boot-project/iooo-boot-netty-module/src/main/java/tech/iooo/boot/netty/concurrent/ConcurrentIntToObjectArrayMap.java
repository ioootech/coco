...
import static tech.iooo.boot.netty.utils.TableUtils.offset;
import static tech.iooo.boot.netty.utils.TableUtils.tableSizeFor;
	...
	private void ensureCapacity(int capacity) {
		...
		synchronized (this) {
			...
			if (newCapacity > MAXIMUM_CAPACITY) {
				throw new IndexOutOfBoundsException(String.valueOf(newCapacity));
			}
