...
public interface Timeout {
  ...
  /**
   * Attempts to cancel the {@link TimerTask} associated with this handle. If the task has been executed or cancelled already, it will return with no side effect.
   *
