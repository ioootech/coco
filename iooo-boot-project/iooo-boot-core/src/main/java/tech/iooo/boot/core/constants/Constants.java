...
public abstract class Constants {
  ...
  public static final String IOOO_PROPERTIES_KEY = "iooo.properties.file";

  public static final String DEFAULT_IOOO_PROPERTIES = "iooo.properties";
  ...
  public static final String DEFAULT_DIRECTORY = "iooo";

  public static final String DEFAULT_LOADBALANCE = "random";

  public static final String DEFAULT_PROTOCOL = "iooo";
  ...
  public static final String DEFAULT_REMOTING_CODEC = "iooo";
...
//    public static final int DEFAULT_REGISTRY_CONNECT_TIMEOUT = 5000;
  ...
  public static final String DEFAULT_REGISTRY = "iooo";
  ...
  public static final String DEFAULT_PROMPT = "iooo>";
  ...
  public static final String IOOO_VERSION_KEY = "iooo";
  ...
  @Deprecated
  public static final String SHUTDOWN_WAIT_SECONDS_KEY = "iooo.service.shutdown.wait.seconds";

  public static final String SHUTDOWN_WAIT_KEY = "iooo.service.shutdown.wait";
  ...
  public static final String STUB_EVENT_KEY = "iooo.stub.event";

  public static final boolean DEFAULT_STUB_EVENT = false;

  public static final String STUB_EVENT_METHODS_KEY = "iooo.stub.event.methods";
  ...
  public static final String IOOO_IP_TO_REGISTRY = "IOOO_IP_TO_REGISTRY";

  public static final String IOOO_PORT_TO_REGISTRY = "IOOO_PORT_TO_REGISTRY";

  public static final String IOOO_IP_TO_BIND = "IOOO_IP_TO_BIND";

  public static final String IOOO_PORT_TO_BIND = "IOOO_PORT_TO_BIND";
