...
/**
 * The internal data structure that stores the threadLocal variables for Netty and all {@link InternalThread}s. Note that this class is for internal use only. Use {@link
 * InternalThread} unless you know what you are doing.
 */
