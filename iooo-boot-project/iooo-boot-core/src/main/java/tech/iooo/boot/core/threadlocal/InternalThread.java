...
public class InternalThread extends Thread {
  ...
  /**
   * Returns the internal data structure that keeps the threadLocal variables bound to this thread. Note that this method is for internal use only, and thus is subject to change at
   * any time.
   */
  ...
  /**
   * Sets the internal data structure that keeps the threadLocal variables bound to this thread. Note that this method is for internal use only, and thus is subject to change at
   * any time.
   */
