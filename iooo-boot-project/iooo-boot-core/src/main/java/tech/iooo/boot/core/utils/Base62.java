...
public class Base62 {
  ...
  /**
   * Uses the elements of a byte array as indices to a dictionary and returns the corresponding values in form of a byte array.
   */
