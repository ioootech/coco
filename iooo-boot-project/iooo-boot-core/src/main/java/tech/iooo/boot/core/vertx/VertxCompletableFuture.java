...
public class VertxCompletableFuture<T> extends CompletableFuture<T> implements CompletionStage<T> {
  ...
  /**
   * Returns a new CompletableFuture that is asynchronously completed by a task running in the current Vert.x {@link Context} after it runs the given action.
   * <p>
   * This method is different from {@link CompletableFuture#supplyAsync(Supplier)} as it does not use a fork join executor, but use the Vert.x context.
   *
   * @param vertx the Vert.x instance
   ...
   * Returns a new CompletableFuture that is asynchronously completed by a task running in the current Vert.x {@link Context} after it runs the given action.
   * <p>
   * This method is different from {@link CompletableFuture#runAsync(Runnable)} as it does not use a fork join executor, but use the Vert.x context.
   *
   * @param context the context
   * @param runnable the action to run before completing the returned CompletableFuture
   * @return the new CompletableFuture
   ...
   * <p>
   * This method is different from {@link CompletableFuture#supplyAsync(Supplier)} as it does not use a fork join executor, but the worker thread pool.
   *
   * @param vertx the Vert.x instance
   * @param supplier a function returning the value to be used to complete the returned CompletableFuture
   * @param <T> the function's return type
  ...
  /**
   * Returns a new CompletableFuture that is asynchronously completed by a action running in the provided Vert.x worker thread pool.
   * <p>
   * This method is different from {@link CompletableFuture#runAsync(Runnable)} as it does not use a fork join executor, but the worker thread pool.
   *
   * @param vertx the Vert.x instance
   ...
   * Returns a new CompletableFuture that is asynchronously completed by a action running in the provided Vert.x worker thread pool.
   * <p>
   * This method is different from {@link CompletableFuture#runAsync(Runnable)} as it does not use a fork join executor, but the provided worker thread pool.
   *
   * @param context the Vert.x context
   * @param worker the WorkerExecution on which the runnable is to be executed
   * @param runnable the action, when its execution completes, it completes the returned CompletableFuture. If the execution throws an exception, the returned CompletableFuture is
  ...
  /**
   * Returns a new CompletableFuture that is asynchronously completed by a task running in the provided Vert.x worker thread pool.
   * <p>
   * This method is different from {@link CompletableFuture#supplyAsync(Supplier)} as it does not use a fork join executor, but the worker thread pool.
   *
   * @param context the context in which the supplier is executed.
   ...
   * @param vertx the Vert.x instance to retrieve the context
   * @param futures the CompletableFutures
   * @return a new CompletableFuture that is completed with the result or exception of any of the given CompletableFutures when one completes
   * @throws NullPointerException if the array or any of its elements are {@code null}
   */
  ...
  /**
   * Creates a new {@link VertxCompletableFuture} using the current context. This method is used to switch between Vert.x contexts.
   *
  ...
  /**
   * Creates a new {@link VertxCompletableFuture} using the current context or creates a new one. This method is used to switch between Vert.x contexts.
   *
   * @return the created {@link VertxCompletableFuture}
   */
  ...
  /**
   * Creates a new {@link VertxCompletableFuture} using the given context. This method is used to switch between Vert.x contexts.
   *
   * @return the created {@link VertxCompletableFuture}
   */
  ...
  /**
   * Creates a new {@link Future} object completed / failed when the current {@link VertxCompletableFuture} is completed successfully or not.
   *
